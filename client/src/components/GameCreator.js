...
export default class GameCreator extends Component {
  ...
  render() {
    return (
      <form style={{textAlign: "left", margin: "2em"}}>
        <div className="row">
          <div className="six columns">
            <label htmlFor="xoselect">Your Letter</label>
              <select name="XOValue" value={this.state.XOValue} onChange={this.handleChange} className="u-full-width" id="xoselect">
          ...
          <div className="six columns">
            ...
            <select name="gridLockState" value={this.state.gridLockState} onChange={this.handleChange} className="u-full-width" id="subgridcompletionselect">
